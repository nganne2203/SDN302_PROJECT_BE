...
const CHECKOUT_PREVIEW_FIELDS = GENERATE_UTILS.extractFieldsFromJoi(
  ORDER_VALIDATION.checkoutPreview
)

const CHECKOUT_PREVIEW_REQUIRED_FIELDS = GENERATE_UTILS.extractRequiredFieldsFromJoi(
  ORDER_VALIDATION.checkoutPreview
)
...
export const ORDER_CONSTANT = {
  ...
  CHECKOUT_PREVIEW_FIELDS,
  CHECKOUT_PREVIEW_REQUIRED_FIELDS
}
